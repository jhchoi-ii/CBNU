...
parser.add_argument('--path', default='./b3 (6).jpg', help='Image path.')
...
while True:
    ...
    #Morphology
        ...
        #_image = cv2.resize(_image, None, fx=0.5, fy=0.5)
    ...
    #Canny
        ...
        work_image = cv2.resize(work_image, None, fx=0.5, fy=0.5)
        cv2.imshow("Work", work_image)
        cv2.waitKey(0)
    ...
    #Image subtract
        ...
        _image = cv2.resize(_image, None, fx=0.5, fy=0.5)
        target_image = cv2.imread('./b0 (2).jpg')
